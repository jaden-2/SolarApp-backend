...
--
DROP SEQUENCE IF EXISTS public.batteries_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.breakers_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.controllers_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.inverters_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.panels_id_seq CASCADE;
...
--
-- Name: breakers; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: breakers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: breakers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: inverters; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: inverters_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: inverters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: breakers id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: inverters id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: batteries; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: breakers; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: inverters; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: batteries_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: breakers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: controllers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: inverters_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: breakers breakers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: inverters inverters_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
